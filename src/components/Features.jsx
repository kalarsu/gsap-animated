...
export const BentoTilt = ({children, className = ''}) =>{
    ...
    const handleMouseMove = (e) => {
        ...
        const newTransformStyle = `perspective(700px) rotateX(${tiltX}deg) rotateY(${tiltY}deg)
                ...
                <div className="grid grid-cols-2 grid-rows-3 h-[135vh] gap-7">
                    ...
                    <BentoTilt className="bento-title_2">
                        <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
                            <h1 className="bento-title special-font max-w-64 text-black">M<b>o</b>re co<b>m</b>i<b>n</b>g s<b>o</b>on.</h1>
